...
<html lang="en">
    ...
    <body class="hold-transition light-skin sidebar-mini theme-primary fixed">
        ...
        <div class="wrapper">
                ...
                <div class="container-full">
                    ...
                    <div class="content-header">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <button data-pid="-1" class="btn btn-primary edit-involvedlist"> <i class="fi fi-br-plus"></i>
                    ...
                    <section class="content">
                        <div class="row">
                                ...
                                <div class="box">
                                    <div class="box-body">
                                        ...
                                        <label class="cus-switch">
                                           <input type="checkbox" id="public_function_manageid" data-section="23" <?= (isset($involvemaster['status']) && $involvemaster['status']==1) ? 'checked' : '' ?>>

                                            <span class="cus-slider"></span>
                                        </label>
                                    </div>  
                                        <div class="table-responsive">
                                            <table id="involvedlist_table" class="text-fade table table-bordered display">
                            ...
                            <div id="involvedlist-modal" class="modal modal-right fade" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog modal-sm model_vs">
                                    <div class="modal-content">
                                        ...
                                        <form data-validate class="overflow-auto involvedlist-form">
                                            <div class="modal-body">
                                                ...
                                                <div class="modal-footer modal-footer-uniform w-100">
                                                    <input type="hidden" name="web_involved_id" value="-1">
            ...
            <script src="<?= CSS_PATH ?>/js/pages/involvedlist.js"></script>
    </body>
