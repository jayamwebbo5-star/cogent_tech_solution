...
<html lang="en">
    ...
    <body class="hold-transition light-skin sidebar-mini theme-primary fixed">
                ...
                <div class="container-full">
                    ...
                    <div class="content-header">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <button data-pid="-1" class="btn btn-primary edit-looks"> <i class="fi fi-br-plus"></i>
                    ...
                    <section class="content">
                            ...
                            <div class="box">
                                <div class="box-body">
                                    <div class="table-responsive">
                                        <table id="looks_table" class="text-fade table table-bordered display">
                        ...
                        <div id="looks-modal" class="modal modal-right fade" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog modal-sm model_vs">
                                <div class="modal-content">
                                    ...
                                    <form data-validate class="overflow-auto looks-form">
                                            ...
                                            <div class="row">
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <textarea type="text" name="web_content" placeholder=""
                                                                      class="form-control" required=""
                                                                      data-validation-required-message="This field is required"
                                            ...
                                            <div class="row">
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <textarea type="text" name="web_content_page" placeholder=""
                                                                      class="form-control" required=""
                                                                      data-validation-required-message="This field is required"
                                                                      aria-invalid="false"></textarea>
                                                        </div>
                                        ...
                                        <div class="modal-footer modal-footer-uniform w-100">
                                            <input type="hidden" name="web_looks_id" value="-1">
        ...
        <script src="<?= CSS_PATH ?>/js/pages/looks.js"></script>
