...
<html lang="en">
    ...
    <body class="hold-transition light-skin sidebar-mini theme-primary fixed">
        ...
        <div class="wrapper">
                ...
                <div class="container-full">
                    ...
                    <div class="content-header">
                        <div class="d-flex flex-wrap align-items-center justify-content-between">
                            ...
                            <div class=" col-6 mx-auto order-3 order-md-2 my-2 my-md-0">
                                <form class="row gx-2 heading-form">
                                    <div class="col-12 col-md-6 mb-2 mb-md-0 ">
                                        ...
                                        <input class="form-control" style="    margin-bottom: 5px;" name="web_title" value="<?= $heading['web_title'] ?>" placeholder="Enter title">

                                        <input class="form-control" style="    margin-bottom: 5px;" name="web_content" value="<?= $heading['web_content'] ?>" placeholder="Enter Description">
                            ...
                            <div class="col-3 order-2 order-md-3 text-end">                               
                                <button data-pid="-1" class="btn btn-primary edit-tab"> <i class="fi fi-br-plus"></i>
                    ...
                    <section class="content">
                        <div class="row">
                                ...
                                <div class="box">
                                    <div class="box-body">
                                        <div class="table-responsive">
                                            <table id="tab_table" class="text-fade table table-bordered display">
                            ...
                            <div id="tab-modal" class="modal modal-right fade" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog modal-sm model_vs">
                                    <div class="modal-content">
                                        ...
                                        <form data-validate class="overflow-auto tab-form">
                                                    ...
                                                    <div class="row">
                                                         ...
                                                         <div class="col-md-10">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group mb-3">
                                                                    <select class="form-control" name="web_menu_id"
                                                      ...
                                                      <div class="col-md-10">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">
                                                                    <input type="text" name="btn_name" placeholder=""
                                                                           class="form-control" required=""
                                                                           data-validation-required-message="This field is required"
                                                                           aria-invalid="false">
                                                                </div>
                                            ...
                                            <div class="modal-footer modal-footer-uniform w-100">
                                                <input type="hidden" name="web_tab_id" value="-1">
            ...
            <script src="<?= CSS_PATH ?>/js/pages/tab.js"></script>
    </body>
