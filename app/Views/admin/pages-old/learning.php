...
<html lang="en">
    ...
    <body class="hold-transition light-skin sidebar-mini theme-primary fixed">
        ...
        <div class="wrapper">
                ...
                <div class="container-full">
                    ...
                    <div class="content-header">
                        <div class="d-flex flex-wrap align-items-center justify-content-between">
                            ...
                            <div class="col-3 order-2 order-md-3 text-end">                               
                                <button data-pid="-1" class="btn btn-primary edit-learning"> <i class="fi fi-br-plus"></i>
                    ...
                    <section class="content">
                        <div class="row">
                                ...
                                <div class="box">
                                    <div class="box-body">
                                        <div class="table-responsive">
                                            <table id="learning_table" class="text-fade table table-bordered display">
                            ...
                            <div id="learning-modal" class="modal modal-right fade" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog modal-sm model_vs">
                                    <div class="modal-content">
                                        ...
                                        <form data-validate class="overflow-auto learning-form">
                                            <div class="modal-body">
                                                <div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-10">
                                                            <div class="form-group">
                                                                <label class="form-label">Button Name <span
                                                                        class="text-danger">*</span></label>
                                                                <div class="input-group mb-3">

                                                                    <input type="text" name="web_btn_name"
                                                                           class="form-control" required=""
                                                                           data-validation-required-message="This field is required"
                                                                           aria-invalid="false">
                                                                </div>
                                            ...
                                            <div class="modal-footer modal-footer-uniform w-100">
                                                <input type="hidden" name="web_learning_id" value="-1">
            ...
            <script src="<?= CSS_PATH ?>/js/pages/learning.js"></script>
    </body>
