                                ...
                                <div class="box"> 
                                    <form class="form form-content">
                                        <div class="box-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <h4 class="box-title text-primary mb-0"><i class="ti-user me-15"></i> Partner </h4>
                                                    <hr class="my-15">
                                                </div>
                                                <div class="col-md-6">
                                                    <h4 class="box-title text-primary mb-0"><i class="ti-user me-15"></i> Below Partner</h4>
                                                    <hr class="my-15">
                                                </div>
                                            ...
                                            <h4 class="box-title text-primary mb-0"><i class="ti-user me-15"></i> Partner Count</h4>
                                            <hr class="my-15">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
