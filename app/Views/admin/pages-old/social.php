                                ...
                                <div class="box"> 
                                    <form class="form form-setting">
                                        <div class="box-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <span class="input-group-text"><i class="bi bi-phone"></i></span>
                                                            <input type="text" name="user_phone_2" value="<?= $data['user_phone_2'] ?>" class="form-control"  >
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3"> 
                                                            <input type="text" class="form-control" value="<?= $data['address_4'] ?>"  name="address_4">
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <h4 class="box-title text-primary mb-0"><i class="ti-user me-15"></i>Contactus Content</h4>
                                            <hr class="my-15">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="text" class="form-control" value="<?= $data['contentus_title'] ?>"  name="contentus_title">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <textarea type="text" class="form-control" rows="5"  name="contentus_title_content"><?= $data['contentus_title_content'] ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                 </div>
